...
.section - head span:after {
  right: 0;
  background: -webkit - gradient(linear, left top, right top, from(transparent), to(#6f02a6));
  background: linear - gradient(to right, transparent, #6f02a6);
}
.section - head span:before {
  left: 0;
  background: -webkit - gradient(linear, right top, left top, from(transparent), to(#6f02a6));
  background: linear - gradient(to left, transparent, #6f02a6);
}
.section - head span i {
  display: inline - block;
  width: 7px;
...
.hero.content.skills.skill - item {
  margin - bottom: 20px;
}
.hero.content.skills.skill - item: last - child {
  margin - bottom: 0;
}
.hero.content.skills.skill - item h5 {
  font - size: 14px;
  font - weight: 500;
  margin - bottom: 10px;
}
.hero.content.skills.skill - progress {
  width: 100 %;
  height: 26px;
...
.hero.content.skills.skill - progress.progres {
  position: absolute;
  height: 100 %;
  width: 10 %;
  left: 0;
  top: 0;
  background: #6f02a6;
  background: -webkit - gradient(linear, left top, right top, from(#555), to(#6f02a6));
  background: linear - gradient(to right, rgb(222, 178, 238),#6f02a6);
  border - radius: 20px;
  -webkit - transition: all 1.5s;
  transition: all 1.5s;
}
.hero.content.skills.skill - progress.progres:before {
...
.hero.content.skills.skill - progress.progres:after {
  content: "";
  width: 0;
  height: 0;
